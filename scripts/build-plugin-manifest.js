...
for (let language in languages) {
  ...
  plugins.forEach(plugin => {
    ...
    // Download sources opt in via getDownloadUrl (see docs.md
    // "File/download sources"). Absent => chapter plugin (default).
    const kind =
      typeof instance.getDownloadUrl === 'function' ? 'download' : undefined;
